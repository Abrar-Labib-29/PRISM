...
| TASK-P4.4 | 4 — Results | Toast notification manager | §8.1.9 | TASK-P3.1 | Not Started | `src/ui/components/toast.py` |
| TASK-P4.5 | 4 — Results | Welcome zero-state guidance | §8.1.8 | TASK-P3.1, TASK-P3.5 | Not Started | `src/ui/components/welcome.py` |
| TASK-P5.1 | 5 — Export | Export control panel (tksheet BOM grid) | §8.1.5 item 5, §8.4 | TASK-P3.1, TASK-P1.9, TASK-P1.10 | Not Started | `src/ui/components/export_panel.py` |
| TASK-P6.1 | 6 — Packaging | Boot splash image generation | §8.1.7a, §8.1.11 | none | Not Started | `assets/branding/boot_splash.png` |
| TASK-P6.2 | 6 — Packaging | PyInstaller build & native splash handoff | §9.7, §8.1.7a, §12.7 STR-10 | All prior tasks | Not Started | `main.py`, `prism.spec` |
| TASK-P6.3 | 6 — Packaging | Icon & branding assets | §8.1.1, §8.1.11 | none | Not Started | `assets/branding/ivalue_prism.ico`, `assets/branding/ivalue_prism_logo.png`, `assets/icons/` |
